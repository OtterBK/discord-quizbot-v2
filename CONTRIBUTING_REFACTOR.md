...
작업 중 성능/메모리/로직 최적화 여지가 눈에 띄면(리팩토링과는 별개로) 즉시 고치지 말고
`PERFORMANCE_NOTES.md`에 위치와 내용만 기록해둔다 (사용자 확인, 2026-08-03). 별도 `docs:`
커밋 또는 관련 `refactor:`/`fix:` 커밋에 포함해서 남긴다.
...
- [ ] `PERFORMANCE_NOTES.md`에 이번 작업 중 발견한 성능/최적화 포인트 기록 여부 확인
