...
const { SYSTEM_CONFIG, CUSTOM_EVENT_TYPE, BGM_TYPE } = require('../../config/system_setting.js');
...
//quiz_session.js가 lifecycle 대부분을 소유하게 되면서, 여기 남은 멀티플레이 관련
//클래스들이 실제로 이름으로 참조하는 것만 남김 (QuizSession/lifecycle 나머지는
//session/quiz_session.js, lifecycle/*.js 참고) - REFACTOR_PLAN.md Phase 2
