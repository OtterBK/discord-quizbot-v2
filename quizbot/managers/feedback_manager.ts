...
exports.addQuizLikeAuto = async (interaction: any, quiz_id: string, quiz_title: string): Promise<void> =>
{
  ...
  exports.addQuizLike(quiz_id, guild_id, user_id)
    ...
    .catch((err: unknown) => //예전엔 여기 catch가 없어서 DB 에러 시 사용자에게 아무 응답도 안 갔음
    {
...
exports.addQuizLike = async (quiz_id: string, guild_id: string, user_id: string): Promise<boolean> =>
{
...
exports.checkAlreadyLike = async (quiz_id: string, user_id: string): Promise<boolean> =>
{
